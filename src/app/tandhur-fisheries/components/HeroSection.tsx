...
export default function HeroSection() {
  ...
  return (
    <section
      className={`px-4 md:px-8 lg:ml-20 py-8 w-full max-w-7xl mx-auto transition-all duration-1000 ${
    ...
    >
      ...
      >
        ...
        />
        <h1 className="text-xl md:text-2xl font-bold text-[#145DA0] font-josefin-sans">
          TANDHURFisheries
        </h1>
      </div>
      ...
      >
        TANDHURFisheries is a web-based application designed to support
        stakeholders in the fisheries sector by simplifying the monitoring and
        estimation of fish and shrimp production across various aquaculture
        environments.
      </p>
      ...
      {/* Subtitle */}
      <h1
        className={`text-xl md:text-2xl font-bold text-[#145DA0] mt-5 text-center md:text-left font-josefin-sans transition-all duration-1000 delay-900 ${
          isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-5"
        }`}
      >
